...
public class GuildsClientCommands {
    ...
    public void talkToServer() {
        try (
            ...
            while (true) {
                ...
                String response = guildsClient.sendRequest(userInput);
    ...
    public void launchCmd() {
        ...
        Map<Object, Object> tmp = result.getContext().stream().collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue));
